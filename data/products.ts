...
export const products: Product[] = [
  {
    ...
    image: "/images/products/dedak-menir-1kg.jpg",
    badge: "Hemat",
    featured: true,
    price: 5000,
    shopeeUrl: "#",
  },
  {
    ...
    packaging: [{ size: "1", unit: "kg", description: "Plastik press" }],
    minimumOrder: "1 kemasan",
    image: "/images/products/dedak-halus-1kg.jpg",
    featured: true,
    price: 4000,
    shopeeUrl: "#",
  },
  {
    ...
    minimumOrder: "1 kemasan",
    image: "/images/products/dedak-menir-5kg.jpg",
    badge: "Hemat",
    featured: true,
    price: 20000,
    shopeeUrl: "#",
  },
  {
    ...
    packaging: [{ size: "5", unit: "kg", description: "Karung plastik" }],
    minimumOrder: "1 kemasan",
    image: "/images/products/dedak-halus-5kg.jpg",
    badge: "Populer",
    featured: true,
    price: 15000,
    shopeeUrl: "#",
